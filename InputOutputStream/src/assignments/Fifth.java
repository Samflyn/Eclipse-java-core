...
public class Fifth {
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			System.out.println("===============================================================================");
			System.out
					.println("Dept \t" + "Total \t" + "Male \t" + "Female \t" + "Max \t" + "Min \t" + "Avg \t" + "CTC");
			System.out.println("===============================================================================");
			System.out.println(al.get(0) + "\t" + (mcounter + fcounter) + "\t" + mcounter + "\t" + fcounter + "\t"
					+ al1.get(al1.size() - 1) + "\t" + al1.get(0) + "\t" + avg + "\t" + (mcounter + fcounter) * avg);
			System.out.println(al.get(1) + "\t" + (mcounter1 + fcounter1) + "\t" + mcounter1 + "\t" + fcounter1 + "\t"
					+ al11.get(al11.size() - 1) + "\t" + al11.get(0) + "\t" + avg1 + "\t"
					+ (mcounter1 + fcounter1) * avg1);
			System.out.println(al.get(2) + "\t" + (mcounter11 + fcounter11) + "\t" + mcounter11 + "\t" + fcounter11
					+ "\t" + al111.get(al111.size() - 1) + "\t" + al111.get(0) + "\t" + avg11 + "\t"
					+ (mcounter11 + fcounter11) * avg11);
			System.out.println(al.get(3) + "\t" + (mcounter111 + fcounter111) + "\t" + mcounter111 + "\t" + fcounter111
					+ "\t" + al1111.get(al1111.size() - 1) + "\t" + al1111.get(0) + "\t" + avg111 + "\t"
					+ (mcounter111 + fcounter111) * avg111);
			System.out.println("===============================================================================");
			System.out.println("\t" + "Total Emp : " + (mcounter + fcounter + mcounter1 + fcounter1 + mcounter11
					+ fcounter11 + mcounter111 + fcounter111));
			System.out.println("\t" + "Total Male : " + (mcounter + mcounter1 + mcounter11 + mcounter111));
			System.out.println("\t" + "Total Female : " + (fcounter + fcounter1 + fcounter11 + fcounter111));
			System.out.println("\t" + "Total CTC : " + ((mcounter + fcounter) * avg + (mcounter1 + fcounter1) * avg1
